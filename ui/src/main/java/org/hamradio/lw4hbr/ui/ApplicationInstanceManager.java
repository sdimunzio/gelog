...
public class ApplicationInstanceManager {
	...
	private static Logger log = Logger.getLogger(ApplicationInstanceManager.class.getName());
	...
	public static boolean registerInstance() {
		...
		try {
			...
			try {
				...
				log.error("Error connecting to local port for single instance notification", e);
				return returnValueOnError;
			}
